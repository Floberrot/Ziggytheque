...
<template>
  <div class="p-4 sm:p-6 space-y-6">
    <h1 class="text-2xl font-bold">{{ t('notifications.settings.title') }}</h1>
    ...
    <div class="max-w-2xl mx-auto px-6 py-8 space-y-8">
      ...
      <!-- Async test failures / system notifications -->
      <section v-if="unread && unread.length > 0" class="space-y-2">
        ...
        <div
          ...
          :key="notification.id"
          class="alert"
          :class="notification.type === 'test_failure' ? 'alert-error' : 'alert-info'"
        >
